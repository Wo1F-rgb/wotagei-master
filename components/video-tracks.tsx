...
export function VideoTracks({master,rate,changeMaster,changeRate,canSelf,controlsDisabled,nudgeDisabled,nudge,scope,durations,origins,bpm,known,time,playing,camera,disabled,seek,adjust,pause,save}:Props){
 ...
 return <div className="video-tracks">
  <TrackToolbar master={master} rate={rate} changeMaster={changeMaster} changeRate={changeRate} canSelf={canSelf} disabled={controlsDisabled} nudgeDisabled={nudgeDisabled} nudge={nudge} scope={scope}/>
