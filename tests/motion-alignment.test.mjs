...
import {buildMotionCurve,measureMotionPair,motionAt,motionSamplingPlan,motionTarget} from '../lib/motion-alignment.ts';
...
test('arms, stance width and invisible joints cannot drive roll or fitting of individual body parts',()=>{
 ...
 const rotated=transformPose(a,{...identity,rotation:90},stage);assert.equal(measureMotionPair(a,rotated,stage),null);
});
